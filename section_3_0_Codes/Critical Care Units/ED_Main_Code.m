%% Load weekly data
drugFree = readtable('UHTMC_Emergency_Department_DrugFree_weekly_summary.csv');
drugUsers = readtable('UHTMC_Emergency_Department_DrugUsers_weekly_summary.csv');
