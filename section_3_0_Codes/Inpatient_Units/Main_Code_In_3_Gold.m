%% Load weekly data
drugFree = readtable('Inpatient_3_Gold_DrugUsers_weekly_summary.csv');
drugUsers = readtable('Inpatient_3_Gold_DrugFree_weekly_summary.csv');
...
%% Save .mat results
save('Inpatient_3_Gold.mat', 'results', 'chain', 's2chain');

%% Save chain as CSV
chain_table = array2table(chain, 'VariableNames', results.names);
chain_table.sigma2 = s2chain;
writetable(chain_table, 'Inpatient_3_Gold_chain.csv');
