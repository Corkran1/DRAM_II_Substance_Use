%% Load weekly data
drugFree = readtable('Inpatient_5_North_DrugFree_weekly_summary.csv');
drugUsers = readtable('Inpatient_5_North_DrugUsers_weekly_summary.csv');
...
%% Save .mat results
save('Inpatient_5_North.mat', 'results', 'chain', 's2chain');

%% Save chain as CSV
chain_table = array2table(chain, 'VariableNames', results.names);
chain_table.sigma2 = s2chain;
writetable(chain_table, 'Inpatient_5_North.csv');
