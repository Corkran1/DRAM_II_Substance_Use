%% Load weekly data
drugFree = readtable('HH_Surgery_Dept__DrugFree_weekly_summary.csv');
drugUsers = readtable('HH_Surgery_Dept__DrugUsers_weekly_summary.csv');
