%% Load weekly data
drugFree = readtable('OB_GYN___Overflow_DrugFree_weekly_summary.csv');
drugUsers = readtable('OB_GYN___Overflow_DrugUsers_weekly_summary.csv');
...
%% Save .mat results
save('OB_GYN.mat', 'results', 'chain', 's2chain');
